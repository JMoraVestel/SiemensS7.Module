...
namespace vNode.SiemensS7.Diagnostics
{
    public class DiagnosticMetrics : INotifyPropertyChanged
    {
        ...
        private bool _siemensPlcConnected;
        ...
        {
            SiemensPlcConnected = true;
        }

        public void ConnectionFailed()
        {
            SiemensPlcConnected = false;
        ...
        /// <summary>
        /// Siemens PLC connection status.
        /// </summary>
        public bool SiemensPlcConnected
        {
            get => _siemensPlcConnected;
            private set => SetProperty(ref _siemensPlcConnected, value);
        }
        ...
        public static object GetMetricValue(string metricName, DiagnosticMetrics metrics)
        {
            ...
            else if (string.Equals(metricName, "SiemensPlcConnected", StringComparison.OrdinalIgnoreCase))
                return metrics.SiemensPlcConnected;
